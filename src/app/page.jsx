        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="pt-8 border-t border-slate-200">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                <a 
                  href="https://www.linkedin.com/company/carbonless-network/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-slate-200 hover:bg-emerald-600 rounded-full flex items-center justify-center transition-all hover:scale-110 group"
                  aria-label="LinkedIn"
                >
                  <Icon className="w-5 h-5 text-slate-600 group-hover:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
